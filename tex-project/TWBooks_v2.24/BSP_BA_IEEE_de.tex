...
%
\title{Titel der Arbeit\\Titel der }
\author{Titel Vorname Name, Titel}
\studentnumber{XXXXXXXXXXXXXX}
...
\schlagworte{Schlagwort1, Schlagwort2, Schlagwort3, Schlagwort5}
\outline{\blindtext}
...
Es wird dringend empfohlen, Biber oder BibTeX~zu verwenden (wie in diesen Beispielen) \cite{Calis2020}.
